...
Test(test_ofb, magma_encrypt_ofb) {
    ...
    magma_encrypt_ofb(keys, iv, 16, plain_text, result, 32);
...
Test(test_ofb, magma_decrypt_ofb) {
    ...
    magma_decrypt_ofb(keys, iv, 16, cipher_text, result, 32);
